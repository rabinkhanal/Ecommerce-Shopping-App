...
public class BrowsePhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Browse food");
        setupBottomNav();
    ...
    private void setupBottomNav() {
        ...
        bottomNavigationView.setSelectedItemId(R.id.navigation_bike);
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.navigation_car:
                        startActivity(new Intent(getApplicationContext(), BrowseFood.class));
    ...
    private void getProductsDataFromAPI() {
        ...
        productsData.enqueue(new Callback<List<ProductModel>>() {
            ...
            public void onResponse(Call<List<ProductModel>> call, Response<List<ProductModel>> response) {
                ...
                if (response.isSuccessful()) {
                    if (statusCode == 200) {
                        ...
                        Toast.makeText(BrowsePhone.this, "Cannot fetch data please try again " + response.message(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onFailure(Call<List<ProductModel>> call, Throwable t) {
                Toast.makeText(BrowsePhone.this, "Something went wrong " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
