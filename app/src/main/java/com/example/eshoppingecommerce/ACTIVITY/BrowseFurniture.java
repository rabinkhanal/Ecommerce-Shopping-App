...
public class BrowseFurniture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Browse furniture");
        setupBottomNav();
    ...
    private void setupBottomNav() {
        ...
        bottomNavigationView.setSelectedItemId(R.id.navigation_truck);
